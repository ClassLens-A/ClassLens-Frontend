    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your teaching staff</p>
        </div>
      ...
      {showForm && <TeacherForm token={token} teacher={editingTeacher} onClose={handleFormClose} />}
            ...
            <tbody>
              {loading ? (
                ...
                filteredTeachers.map((teacher) => (
                  <tr key={teacher.id} className="border-b border-border hover:bg-muted/50 transition">
                    <td className="p-6 font-medium text-foreground">{teacher.name}</td>
                    <td className="p-6 text-muted-foreground">{teacher.email}</td>
                    
                    <td className="p-6 text-muted-foreground">{teacher.department_name}</td>
                    <td className="p-6">
