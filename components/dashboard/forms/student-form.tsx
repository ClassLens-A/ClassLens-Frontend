...
interface StudentFormProps {
  token: string | null
  student?: { id: string; name: string; email: string; roll_number: string; class: string } | null
  onClose: () => void
}
  ...
  return (
    <Card className="mb-6 p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-foreground">{student ? "Edit Student" : "Add New Student"}</h2>
